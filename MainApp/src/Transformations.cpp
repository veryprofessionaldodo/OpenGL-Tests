...
int main() {
    ...
    Shader shader = Shader("shaders/transformShader.vs", "shaders/basicShader.fs"); 
    shader.use();
    ...
    while(!glfwWindowShouldClose(window)) {
        ...
        // Set rotation to vertex shader
        //glm::mat4 trans;
        //trans = glm::rotate(trans,glm::radians(90.0f), glm::vec3(0.0f,0.0f,1.0f));
        //trans = glm::scale(trans, glm::vec3(0.5f, 0.5f, 0.5f));

        //unsigned int transformLocation = glGetUniformLocation(shader.ID, "transform");
        //lUniformMatrix4fv(transformLocation, 1, GL_FALSE, glm::value_ptr(trans));
